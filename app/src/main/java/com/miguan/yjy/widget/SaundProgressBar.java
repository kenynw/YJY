...
public class SaundProgressBar extends ProgressBar {
    ...
    public SaundProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        m_textPaint.setColor(getContext().getResources().getColor(R.color.skin_low));
        ...
        if (a != null) {
            m_textPaint.setTextSize(a.getDimension(
                    R.styleable.SaundProgressBar_textSize, 20));
            m_textPaint.setColor(a.getColor(
                    R.styleable.SaundProgressBar_textColor, getContext().getResources().getColor(R.color.skin_low)));
