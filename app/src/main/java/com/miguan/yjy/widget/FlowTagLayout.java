...
public class FlowTagLayout extends ViewGroup {
    ...
    /**
     * FlowLayout get max line
     */
    public int FLOW_TAG_MAX_LINE = 1;
    /**
     * FlowLayout get max line
     */
    public int FLOW_TAG_CHIRD_COUNT = 0;
    ...
    private void reloadData() {
        ...
        for (int i = 0; i < mAdapter.getCount(); i++) {
            ...
            addView(childView, new MarginLayoutParams(LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
            final int finalI = i;
