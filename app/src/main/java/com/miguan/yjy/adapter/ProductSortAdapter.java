...
public class ProductSortAdapter extends BaseAdapter {
    ...
    public ProductSortAdapter(Context context, List<Category> lists) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textView.setText(lists.get(position).getCate_name());
...
//            ProductReadPresenter.start(context,lists);
    ...
    public void onlyAddAll(List<Category> datas) {
        mdatas.addAll(datas);
