...
import static com.miguan.yjy.R.layout.footer_template_4;
...
public enum TemplateType {
    ...
    TEMPLATE_4(4, R.mipmap.image_template_4, Template4ViewHolder.class, 0, footer_template_4),
    ...
    TemplateType(int index, int imageRes, Class<? extends BaseTemplateViewHolder> aClass, int headerRes, int footerRes) {
        mIndex = index;
        mImageRes = imageRes;
        mClass = aClass;
